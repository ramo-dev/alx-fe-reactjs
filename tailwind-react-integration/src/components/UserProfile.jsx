...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg">
      ...
      <h1 className="text-xl text-blue-800 text-base">John Doe</h1>
      <p className="text-gray-600 text-base my-4">Developer at Example Co. Loves to write code and explore new technologies.</p>
    </div>
  );
}
